...
plot(x=epochs,y=loss_epochs_1,type="l",col="red",ylim=(c(0,20)),ylab="squared-error loss",main="Simulated Data (sigma=0.01)")
...
plot(x=iters, y=loss_epochs1_full, type="l")

iters<-1:200
loss_epochs5_full<-as.vector(t(result_5))
plot(x=iters, y=loss_epochs5_full, type="l")

iters<-1:100
loss_epochs10_full<-as.vector(t(result_10))
plot(x=iters, y=loss_epochs10_full, type="l")
...
plot(x=iters_1,y=loss_epochs1_full,type="l",col="red",ylim=c(0,30),ylab="squared-error loss", xlab="scaled iterations",main="Simulated Data (sigma=1)")
...
plot(x=epochs,y=loss_epochs_1,type="l",col="red",ylim=c(0,20),ylab="squared-error loss", main="Simulated Data (sigma=1)")
points(x=epochs,y=loss_epochs_5,type="l",col="blue")
points(x=epochs,y=loss_epochs_10,type="l",col="green")
legend(8,15, legend=c("B=1", "B=5", "B=10"),
       col=c("red", "blue", "green"), lty=1, cex=0.8)
...
plot(x=iters_1,y=loss_epochs1_full,type="l",col="red",ylim=c(0,27),ylab="squared-error loss", xlab="scaled iterations",main="Simulated Data (sigma=1)")
points(x=iters_2,y=loss_epochs5_full,type="l",col="blue")
points(x=iters_3,y=loss_epochs10_full,type="l",col="green")
legend(80,15, legend=c("B=1", "B=5", "B=10"),
       col=c("red", "blue", "green"), lty=1, cex=0.8)
